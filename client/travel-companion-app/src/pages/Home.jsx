...
import heroImage from "../assets/Hero2.png"; // ✅ update the path
import weatherIcon from "../assets/weather-forecast.png";
import currencyIcon from "../assets/change.png";
...
<div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-20 gap-6">
  ...
  <div className="md:w-1/2">
    <img src={heroImage} alt="Hero" className="w-[90%] mx-auto h-auto" />
  </div>
</div>
